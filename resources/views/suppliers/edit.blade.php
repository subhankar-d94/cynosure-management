        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="supplierForm" action="{{ route('suppliers.update', $supplier) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('category') is-invalid @enderror"
                                        ...
                                        <option value="raw_materials" {{ old('category', $supplier->category) == 'raw_materials' ? 'selected' : '' }}>Raw Materials</option>
                                        <option value="manufacturing" {{ old('category', $supplier->category) == 'manufacturing' ? 'selected' : '' }}>Manufacturing</option>
                                        <option value="technology" {{ old('category', $supplier->category) == 'technology' ? 'selected' : '' }}>Technology</option>
                                        <option value="services" {{ old('category', $supplier->category) == 'services' ? 'selected' : '' }}>Services</option>
                                        <option value="logistics" {{ old('category', $supplier->category) == 'logistics' ? 'selected' : '' }}>Logistics</option>
                                        <option value="packaging" {{ old('category', $supplier->category) == 'packaging' ? 'selected' : '' }}>Packaging</option>
                                        <option value="maintenance" {{ old('category', $supplier->category) == 'maintenance' ? 'selected' : '' }}>Maintenance</option>
                                        <option value="consulting" {{ old('category', $supplier->category) == 'consulting' ? 'selected' : '' }}>Consulting</option>
                                    </select>
                                    @error('category')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
